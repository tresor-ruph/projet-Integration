...
import { StyleSheet, View, Button, TextInput, ScrollView, Switch, Text, Picker } from 'react-native';
...
class Form extends React.Component {
  constructor() {
    ...
    envoie() {
      fetch('http://192.168.0.4:3000/reinitmdpE/', {
        method: 'POST',
        body: JSON.stringify({
      ...
      fetch('http://192.168.0.4:3000/auth/', { //192.168.0.15 localhost
        method: 'POST',
        body: JSON.stringify({
          nom: this.state.nom,
      ...
      return ( 
        <ScrollView>
          <View style={styles.container}>
            <Text style={{ fontSize: 30, fontWeight: 'bold', textAlign: 'auto', marginBottom: '1%' }}>Formulaire d'inscription</Text>
            <TextInput
              placeholder="Nom"
              maxLength={50}
