  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TextInput style={styles.texte} placeholder="Insérez votre mot de passe" secureTextEntry={true}/>
        <TextInput style={styles.texte} placeholder="Veuillez confirmer votre mot de passe" secureTextEntry={true}/>
