  ...
  render() {
    return (
      <View style={styles.container}>
        <Title style={{height: '6%', fontSize: 30, textAlign: 'center', marginTop: '10%'}}>
          {' '}
        ...
        <Picker
          style={{height: '9%', fontSize: 19, width: '90%', marginLeft: '5%', marginTop: '2%'}}
          selectedValue={this.state.categorie}
          onValueChange={this.updateCategorie}>
