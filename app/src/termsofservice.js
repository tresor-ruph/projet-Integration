      ...
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <Text style={styles.tcP}>
            ...
            [business name]’s relationship with you in relation to this website. If you disagree with any part of these
            terms and conditions, please do not use our website.
          </Text>
          <Text style={styles.tcP}>
            The term ‘[business name]’ or ‘us’ or ‘we’ refers to the owner of the website whose registered office is
            [address]. Our company registration number is [company registration number and place of registration]. The
          ...
          <Text style={styles.tcL}>
            ...
            timeliness, performance, completeness or suitability of the information and materials found or offered on
          ...
          <Text style={styles.tcL}>
            ...
            we shall not be liable. It shall be your own responsibility to ensure that any products, services or
          ...
          <Text style={styles.tcL}>
            ...
            is not limited to, the design, layout, look, appearance and graphics. Reproduction is prohibited other than
          ...
          <Text style={styles.tcL}>
            ...
            operator, are acknowledged on the website. Unauthorised use of this website may give rise to a claim for
          ...
          <Text style={styles.tcL}>
            ...
            provided for your convenience to provide further information. They do not signify that we endorse the
