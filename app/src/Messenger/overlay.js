...
const OverlayExample = (props) => {
  ...
  const handleAccept = () => {
    ...
    try {
      fetch('http://192.168.1.60:3000/service/addService', requestOptions)
        ...
        <Overlay isVisible={visible} onBackdropPress={toggleOverlay}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.button1}>
              <Button title="Oui" buttonStyle={{width: 80}} onPress={handleAccept} />
            </View>
            <View style={styles.button2}>
              <Button title="Non" buttonStyle={{width: 80}} onPress={handleReject} />
            </View>
            <View style={styles.button3}>
              <Button title="Plus tard" buttonStyle={{width: 100}} onPress={handleLater} />
            </View>
          </View>
        </Overlay>
      ) : (
