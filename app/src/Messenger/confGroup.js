...
function ConfGroup(route, props) {
  ...
  const handleSent = async () => {
    ...
    try {
      fetch('https://help-recover-api.herokuapp.com/group/addGroup', requestOptions)
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      {isPicked ? (
        ...
        <Text style={styles.imageText}>Appuyez sur le cercle pour changer l'image de profil</Text>
      )}
